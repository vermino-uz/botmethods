        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Your Telegram Bots</h1>
                ...
                @else
                    <div class="card">
                        <div class="card-body text-center py-5">
                            ...
                            <h3 class="text-muted mb-3">No Bots Yet</h3>
                            <p class="text-muted mb-4">Get started by adding your first Telegram bot</p>
                            <a href="{{ route('bots.create') }}" class="btn btn-primary">
                                <i class="bi bi-plus-lg me-2"></i>Add New Bot
                            </a>
                        </div>
