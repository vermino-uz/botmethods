...
<head>
    ...
    <style>
        ...
        .hero-section {
            background: linear-gradient(135deg, #3390EC 0%, #2B7DD1 100%);
            color: white;
            padding: 100px 0;
        }
        .feature-icon {
    ...
    <div class="hero-section">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4 fw-bold mb-4">Build Powerful Telegram Bots with Ease</h1>
                    <p class="lead mb-4">Create, manage, and scale your Telegram bots all in one place. No coding required.</p>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="p-4 bg-white rounded-3 h-100 shadow-sm">
                    ...
                    <h3 class="h5 mb-3">Powerful Features</h3>
